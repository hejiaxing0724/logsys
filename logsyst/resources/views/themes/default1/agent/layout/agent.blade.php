                ...
                <nav class="navbar navbar-static-top">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-collapse">
                        ...
                        <ul class="tabs tabs-horizontal nav navbar-nav navbar-left">
							...
							<li @yield('Transactions')><a data-target="#tabE" href="#">{!! Lang::get('lang.transactions') !!}</a></li>
                ...
                <!-- Content Header (Page header) -->
                    ...
                    <div class="tab-content" style="background-color: #80B5D3; position: fixed; width:100% ;padding: 0 0px 0 0px; z-index:999">                    <div class="collapse navbar-collapse" id="navbar-collapse">
                        <div class="tabs-content">
                            ...
                            <div class="tabs-pane @yield('transaction-bar')" id="tabE">
                                <ul class="nav navbar-nav">
                                    <li id="bar" @yield('transactionlist')><a href="{{ url('/transactionlist')}}" >{!! Lang::get('lang.transaction_list') !!}</a></li>
                                    <?php if ($transaction_policy->create()) { ?>
                                        <li id="bar" @yield('newtransaction')><a href="{{ url('/newtransaction')}}" >{!! Lang::get('lang.create_transaction') !!}</a></li>
                                    <?php } ?>
                                </ul>
                            </div>
