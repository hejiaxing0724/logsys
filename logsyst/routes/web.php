...
//    Route::post('org-chart-range', ['as' => 'post.org.chart', 'uses' => 'Agent\helpdesk\OrganizationController@orgChartData']);
        ...
        Route::get('/newtransaction', ['as' => 'newtransaction', 'uses' => 'Agent\helpdesk\TransactionController@newtransaction']); /*  Get Create New Ticket */
        Route::post('/newtransaction/post', ['as' => 'post.newtransaction', 'uses' => 'Agent\helpdesk\TransactionController@post_newtransaction']); /*  Post Create New Ticket */
        Route::get('/transactionlist', ['as' => 'transactionlist', 'uses' => 'Agent\helpdesk\TransactionController@transactionlist']); /*  Get Create New Ticket */
        ...
        Route::post('/ticket/post/change/department', ['as' => 'ticket.post.change.department', 'uses' => 'Agent\helpdesk\TicketController@ticketChangeDepartment']);
...
//    });
    ...
    // Route::get('/', ['as' => '/', 'uses' => 'Client\helpdesk\WelcomepageController@index']);//首页
    Route::get('/', ['as' => '/', 'uses' => 'Admin\helpdesk\AgentController@test']);
...
//    Route::get('/reportdata', 'HomeController@pushdata');
    ...
    Route::any('chunk/upload', ['as' => 'chunk.upload', 'uses' => 'Utility\UploadController@upload']);
    ...
    Route::any('chunk/upload/public', ['as' => 'chunk.upload.public', 'uses' => 'Utility\UploadController@uploadPublic']);
    ...
    Route::get('form/transaction', [
        'as'   => 'custom.form.transaction',
        'uses' => 'Utility\FormController@getTransactionFormJson',
    ]);
    Route::get('transaction/form/dependancy', [
        'as'   => 'api.dependancy',
        'uses' => 'Utility\FormController@dependancy',
    ]);
    Route::get('transaction/form/requester', [
        'as'   => 'api.requester',
        'uses' => 'Utility\FormController@requester',
    ]);
});
